...
def main():
    ...
    R = 105 # total rows in a csv file
    
    rd = pd.concat([pd.read_csv(f"/Project/Hash/Data2/Hash{str(i).zfill(3)}.csv") for i in range(nFile)], ignore_index=True)        
    ...
    outd = pd.concat([pd.DataFrame([[rd.Step.iloc[i], 
                                     ...
                                     rd.Mo1CMax[i::R].median(), rd.Mo1CMax[i::R].mean(), rd.Mo1CMax[i::R].std(),
                                     ...
                                     rd.Mo2CMax[i::R].median(), rd.Mo2CMax[i::R].mean(), rd.Mo2CMax[i::R].std(),
                                     ...
                                     rd.Mo3CMax[i::R].median(), rd.Mo3CMax[i::R].mean(), rd.Mo3CMax[i::R].std(),
                                     ...
                                     rd.Mo4CMax[i::R].median(), rd.Mo4CMax[i::R].mean(), rd.Mo4CMax[i::R].std(),
                                     ...
                                     rd.Mo5CMax[i::R].median(), rd.Mo5CMax[i::R].mean(), rd.Mo5CMax[i::R].std(),
                                     ...
                                     rd.Mo6CMax[i::R].median(), rd.Mo6CMax[i::R].mean(), rd.Mo6CMax[i::R].std(),
                                     ...
                                     rd.Mu1CMax[i::R].median(), rd.Mu1CMax[i::R].mean(), rd.Mu1CMax[i::R].std(),
                                     ...
                                     rd.Mu2CMax[i::R].median(), rd.Mu2CMax[i::R].mean(), rd.Mu2CMax[i::R].std(),
                                     ...
                                     rd.Mu3CMax[i::R].median(), rd.Mu3CMax[i::R].mean(), rd.Mu3CMax[i::R].std(),
                                     ...
                                     rd.Mu4CMax[i::R].median(), rd.Mu4CMax[i::R].mean(), rd.Mu4CMax[i::R].std(),
                                     ...
                                     rd.Mu5CMax[i::R].median(), rd.Mu5CMax[i::R].mean(), rd.Mu5CMax[i::R].std(),
                                     ...
                                     rd.Mu6CMax[i::R].median(), rd.Mu6CMax[i::R].mean(), rd.Mu6CMax[i::R].std(),
                           ...
                           columns=["Step", 
                                    ...
                                    "Mo1CMaxMed", "Mo1CMaxAvg", "Mo1CMaxStd",
                                    ...
                                    "Mo2CMaxMed", "Mo2CMaxAvg", "Mo2CMaxStd",
                                    ...
                                    "Mo3CMaxMed", "Mo3CMaxAvg", "Mo3CMaxStd",
                                    ...
                                    "Mo4CMaxMed", "Mo4CMaxAvg", "Mo4CMaxStd",
                                    ...
                                    "Mo5CMaxMed", "Mo5CMaxAvg", "Mo5CMaxStd",
                                    ...
                                    "Mo6CMaxMed", "Mo6CMaxAvg", "Mo6CMaxStd",
                                    ...
                                    "Mu1CMaxMed", "Mu1CMaxAvg", "Mu1CMaxStd",
                                    ...
                                    "Mu2CMaxMed", "Mu2CMaxAvg", "Mu2CMaxStd",
                                    ...
                                    "Mu3CMaxMed", "Mu3CMaxAvg", "Mu3CMaxStd",
                                    ...
                                    "Mu4CMaxMed", "Mu4CMaxAvg", "Mu4CMaxStd",
                                    ...
                                    "Mu5CMaxMed", "Mu5CMaxAvg", "Mu5CMaxStd",
